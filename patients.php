...
$sql = 'SELECT * FROM patients p, employees e WHERE e.Employee_id = p.Patient_Doctor_id ORDER BY Patient_Name';
$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM patients';
                    ...
                    <div class="table-responsive">
                        ...
                        if($count == 0)
                            echo "<div class=\"alert alert-danger\">
                                    <strong>Alert!</strong> Patient table is empty.
                                  <div>"
                        ?>
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            $ptc = $row['Patient_TcNo'];
                            $p_did = $row['Employee_Name'];
                        ...
                        echo "<div class=\"alert alert-info\">
                                  <strong>Count: </strong> $count Patients are resident.
                            </div>";
                        ?>
                    </div>
                </div>
