...
$sqldoctor = "SELECT * FROM doctorv ORDER BY Employee_Name"; 
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="table-responsive">
                       <form action="add_patient.php" method="post" class="form-inline">

                       <label class="col-lg-3">Patient's Name</label>
                       <input name="patientsname" class="form-control"><br>

                       <label class="col-lg-3">Patient's TcNo</label>
                       <input name="patientstcno" class="form-control"><br>

                       <label class="col-lg-3">Doctor's Name</label>
                       <select name="ddoctors" class="form-control">
                       <?php
