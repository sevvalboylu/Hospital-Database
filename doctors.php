...
$sql = 'SELECT * FROM doctorv dv,  departments d WHERE dv.Employee_Did = d.Department_id ORDER BY Employee_Name';

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM doctorv';
                    ...
                    <div class="table-responsive">
                        ...
                        if($count == 0)
                            echo "<div class=\"alert alert-danger\">
                                    <strong>Alert!</strong> Doctor table is empty.
                                  <div>"
                        ?>
                            ...
                            echo "<P>
                                <table class=\"table table-bordered table-hover\">
                                     ...
                                     <tbody>";
                                        ...
                                        {
                                            $dname = $row['Employee_Name'];
                                            $d_did = $row['Department_name'];
                                            echo "<tr>
                                            	      <td>$dname</td>
                                                      <td>$d_did</td>
                                                      </tr>"; }
                        ...
                        echo "<div class=\"alert alert-info\">
                                  <strong>Count: </strong> $count Doctors
                            </div>";
                        ?>
                    </div>
                </div>
