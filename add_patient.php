...
$P_name = $_POST['patientsname'];
$P_Tcno = $_POST['patientstcno'];
$P_doctor = $_POST['ddoctors'];


$sql = "INSERT INTO patients(Patient_Name, Patient_TcNo, Patient_Doctor_id) VALUES ('$P_name', '$P_Tcno', '$P_doctor')";
                    ...
                    <div class="table-responsive">
                        ...
                        if($result) {
                            echo "<div class=\"alert alert-success\">
                                    <strong>Well done! </strong> Patient : $P_name  is added successfully
                                </div>";
                        }
                        else {
