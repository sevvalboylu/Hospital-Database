...
$sql = 'SELECT * FROM visits order by Visitor_Name';

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM visits';
                    ...
                    <div class="table-responsive">
                        ...
                        if($count != 0)
                           ...
                           <thead>
                                     <tr:hover>
                                     <th>Visitor Name </th>
                                     <th>Visitor's Patient Name</th>
                                     <th>Visitor's Tc No</th>
                                     </thead>
                                     ...
                                     <tbody>";
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                        {
                                             ...
                                             $Vtc = $row['Visitor_TcNo'];
                                             $VPname = $row['Patient_Name'];
                        ...
                        echo "<div class=\"alert alert-info\">
                                  <strong>Count: </strong> $count Visitors
                            </div>";
                        ?>
                    </div>
                </div>
