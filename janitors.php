...
$sql = 'SELECT * FROM janitorv j, departments d WHERE j.Employee_Did = d.Department_id ORDER BY Employee_Name';

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM janitorv';
                ...
                <div class="col-lg-6">
                    <div class="table-responsive">
                            ...
                            echo "<P>
                                <table class=\"table table-bordered table-hover\">
                                     ...
                                     <tbody>";
                                        ...
                                        {
                                            $jname = $row['Employee_Name'];
                                            $j_did = $row['Department_name'];
                                            echo "<tr>
                                                      <td>$jname</td>
                                                      <td>$j_did</td>
                                                      </tr>"; }
                        ...
                        echo "<div class=\"alert alert-info\">
                                  <strong>Count: </strong> $count Janitors 
                            </div>";
                        ?>
                    </div>
                </div>
