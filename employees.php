...
$sql = 'SELECT * FROM employees e, departments d WHERE e.Employee_Did = d.Department_id ORDER BY Employee_Name';

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM employees';
                    ...
                    <div class="table-responsive">
                        ...
                        if($count == 0)
                            echo "<div class=\"alert alert-danger\">
                                    <strong>Alert!</strong> Employee table is empty.
                                  <div>"
                        ?>
                                ...
                                <table class=\"table table-bordered table-hover\">
                                     ...
                                     <tbody>";
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            $etc = $row['Employee_TcNo'];
                                            $etype = $row['Employee_Type'];
                                            $edid = $row['Department_name'];
                        ...
                        echo "<div class=\"alert alert-info\">
                                  <strong>Count: </strong> $count Employees
                            </div>";
                        ?>
                    </div>
                </div>
