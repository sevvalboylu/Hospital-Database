...
$sqletype = "SELECT * FROM rooms "; 
$sqletyperesult = mysqli_query($db, $sqletype);

$sqldype = "SELECT * FROM nursev "; 
...
<head>
    ...
    <title>Assign Nurse To Room</title>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="table-responsive">
                       <form action="Nurseadd.php" method="post" class="form-inline">

                        <label class="col-lg-6">Nurse Name</label>
                       <select name="edtype" class="form-control">
                       <?php
                       while($row = mysqli_fetch_assoc($sqldyperesult)) 
                        {
                            $edid = $row['Employee_id'];
                            $edname = $row['Employee_Name'];
