...
$sqldoctor = "SELECT * FROM patients ORDER BY Patient_Name"; 
$doctorResult = mysqli_query($db, $sqldoctor);
?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="table-responsive">
                       <form action="add_visitor.php" method="post" class="form-inline">

                       <label class="col-lg-3">Visitor's Name</label>
                       <input name="visitorname" class="form-control"><br>

                       <label class="col-lg-3">Visitor's TcNo</label>
                       <input name="visitortcno" class="form-control"><br>

                       <label class="col-lg-3">Patient's Name</label>
                      <select name="visitorpatient" class="form-control">
                       <?php
                       while($row = mysqli_fetch_assoc($doctorResult)) 
                       	{
                       		...
                       		echo "<option value = $patientid>$patientname\n";
                       		}
                       		?>
                           </select><br>
