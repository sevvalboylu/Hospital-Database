...
$sql = 'SELECT * FROM stays_in ORDER BY `stays_in`.`Room_id` ASC';

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM stays_in';
                    ...
                    <div class="table-responsive">
                        ...
                        if($count == 0)
                            echo "<div class=\"alert alert-danger\">
                                    <strong>Alert!</strong> Room table is empty.
                                  <div>"
                        ?>
                        ...
                        echo "<div class=\"alert alert-info\">
                                  <strong>Count: </strong> $count Rooms are occupied
                            </div>";
                        ?>
                    </div>
                </div>
