...
$P_name = $_POST['visitorname'];
$P_Tcno = $_POST['visitortcno'];
$P_doctor = $_POST['visitorpatient'];


$sql = "INSERT INTO visitors(Visitor_Name, Visitor_TcNo, Visitor_Pid) VALUES ('$P_name', '$P_Tcno', '$P_doctor')";
                    ...
                    <div class="table-responsive">
                        ...
                        if($result) {
                            echo "<div class=\"alert alert-success\">
                                    <strong>Well done! </strong>Visitor : $P_name  is added successfully.
                                   </div>";
                        }
                        else {
