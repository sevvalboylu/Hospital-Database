...
$sql = 'SELECT Employee_Name, Department_name FROM vorks_in ORDER BY `vorks_in`.`Department_name` ASC';

$result = mysqli_query($db, $sql);

$sqlCount = 'SELECT COUNT(*) as count FROM vorks_in';
...
<head>
    ...
    <title>Departments of Employees</title>
                    ...
                    <div class="table-responsive">
                        ...
                        if($count == 0)
                            echo "<div class=\"alert alert-danger\">
                                    <strong>Alert!</strong> Departments of Employees table is empty.
                                  <div>"
                        ?>
