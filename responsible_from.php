...
$sql = 'SELECT * FROM nurse_roomv ORDER BY `nurse_roomv`.`Room_id` ASC';
$result = mysqli_query($db, $sql);


$sqlCount = 'SELECT COUNT(*) as count FROM nurse_roomv';
                    ...
                    <div class="table-responsive">
                        ...
                        if($count == 0)
                            echo "<div class=\"alert alert-danger\">
                                    <strong>Alert!</strong> The table is empty.
                                  <div>"
                        ?>
